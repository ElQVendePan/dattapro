...
// 2. Definimos las props que recibirán las páginas
...
const Signup: React.FC = () => {
    // --- Lógica de Paginación (sigue igual) ---
    ...
    // 4. ¡UNICO HANDLER! Esta función genérica actualiza el estado.
