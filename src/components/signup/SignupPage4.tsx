...
const SignupPage4 = ({ register, watchValues, tiposProyecto }: any) => {
    return (
        <>
            ...
            <div className="text-sm mt-4">
                ...
                <Question>
                    ...
                    <Input type="number" {...register("experiencia_profesor", { required: true })} icon={<FaClock className="w-full h-full" />} placeholder="Años de experiencia como profesor" />
                </Question>
                <Question>
                    ...
                    <CheckboxList
                        ...
                        register={register}
                        items={tiposProyecto}
                        selectedValues={watchValues.tiposProyectoValue || []}
                    />
                </Question>
                <Question>
                    <QuestionLabel>3. Descripción breve de los proyectos más relevantes</QuestionLabel>
                    <TextArea {...register("proyectos_text", { required: true })} placeholder="Descripción breve de los proyectos más relevantes" />
                </Question>
            </div>
        </>
    )
