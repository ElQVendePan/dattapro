...
const PerfilSmallCard = () => {
    return (
        <div className="p-4 bg-bg-secondary rounded-2xl relative inline-block w-74 select-none cursor-pointer border-1 border-bg-secondary hover:scale-102 hover:border-primary duration-200">
            <div className="p-0.5 px-3 text-xs bg-primary rounded-lg inline-block font-bold absolute -top-2 -right-2">¡Nuevo!</div>
            ...
            <div className="mt-6 flex items-center gap-2 text-xs bg-orange-400 bg-opacity-20 text-white w-max p-1 pr-4 rounded-full">
