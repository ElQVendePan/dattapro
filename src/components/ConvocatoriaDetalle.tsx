...
const ConvocatoriaDetalle = ({ convocatoria }: ConvocatoriaDetalleProps) => {
    ...
    return (
        <div className="bg-bg-primary lg:bg-bg-secondary p-6 rounded-2xl relative lg:sticky lg:top-6 overflow-auto h-[calc(100vh-3rem)]">
            <div className="w-full h-64 lg:h-56 absolute top-0 left-0">
                <img src={convocatoria.imagenFondo} className="w-full h-full object-cover opacity-50" alt={convocatoria.titulo} />
            ...
            <div className="relative mt-48 lg:mt-40 lg:px-10">
